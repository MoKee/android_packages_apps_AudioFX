...
import com.mokee.audiofx.activity.ActivityMusic;
import com.mokee.audiofx.activity.MasterConfigControl;
import com.mokee.audiofx.backends.EffectSet;
import com.mokee.audiofx.receiver.QuickSettingsTileReceiver;
...
public class AudioFxService extends Service
    ...
    public static final String ACTION_UPDATE_TILE = "com.mokee.audiofx.action.UPDATE_TILE";
    ...
    public void onCreate() {
        ...
        final MKAudioManager cma = MKAudioManager.getInstance(getApplicationContext());
            ...
            if (ACTION_UPDATE_TILE.equals(intent.getAction())) {
                ...
                if (action.equals(AudioEffect.ACTION_OPEN_AUDIO_EFFECT_CONTROL_SESSION)) {
                    ...
                    if (info != null && info.getSessionId() > 0) {
                        boolean added = intent.getBooleanExtra(MKAudioManager.EXTRA_SESSION_ADDED,
                                false);
                        if (added) {
                            mSessionManager.addSession(info);
                        } else {
    ...
    private void updateQsTile() {
        ...
        MKStatusBarManager.getInstance(this).publishTile(TILE_ID, mTile);
    }
