...
import static com.mokee.audiofx.Constants.DEVICE_AUDIOFX_EQ_PRESET_LEVELS;
...
import static com.mokee.audiofx.Constants.DEVICE_AUDIOFX_REVERB_PRESET;
...
import static com.mokee.audiofx.Constants.DEVICE_DEFAULT_GLOBAL_ENABLE;
import static com.mokee.audiofx.activity.MasterConfigControl.getDeviceIdentifierString;
import static com.mokee.audiofx.service.AudioFxService.ALL_CHANGED;
import static com.mokee.audiofx.service.AudioFxService.BASS_BOOST_CHANGED;
import static com.mokee.audiofx.service.AudioFxService.ENABLE_REVERB;
import static com.mokee.audiofx.service.AudioFxService.EQ_CHANGED;
import static com.mokee.audiofx.service.AudioFxService.REVERB_CHANGED;
import static com.mokee.audiofx.service.AudioFxService.TREBLE_BOOST_CHANGED;
import static com.mokee.audiofx.service.AudioFxService.VIRTUALIZER_CHANGED;
import static com.mokee.audiofx.service.AudioFxService.VOLUME_BOOST_CHANGED;
...
import com.mokee.audiofx.eq.EqUtils;
...
class SessionManager implements AudioOutputChangeListener.AudioOutputChangedCallback {
    ...
    private final MKAudioManager mCMAudio;
    ...
    public SessionManager(Context context, Handler handler, DevicePreferenceManager devicePrefs,
        ...
        mContext = context;
        mCMAudio = MKAudioManager.getInstance(context);
