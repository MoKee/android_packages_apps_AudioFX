    ...
    public static String getDeviceDisplayString(Context context,  AudioDeviceInfo info) {
        ...
        switch (type) {
            ...
            case TYPE_WIRED_HEADPHONES:
                return context.getString(org.mokee.audiofx.R.string.device_headset);
            case TYPE_LINE_ANALOG:
            case TYPE_LINE_DIGITAL:
                return context.getString(org.mokee.audiofx.R.string.device_line_out);
            ...
            default:
                return context.getString(org.mokee.audiofx.R.string.device_speaker);
        }
    }
