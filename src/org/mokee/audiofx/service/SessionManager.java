...
import static org.mokee.audiofx.Constants.DEVICE_AUDIOFX_EQ_PRESET_LEVELS;
...
import static org.mokee.audiofx.Constants.DEVICE_AUDIOFX_REVERB_PRESET;
...
import static org.mokee.audiofx.Constants.DEVICE_DEFAULT_GLOBAL_ENABLE;
import static org.mokee.audiofx.activity.MasterConfigControl.getDeviceIdentifierString;
import static org.mokee.audiofx.service.AudioFxService.ALL_CHANGED;
import static org.mokee.audiofx.service.AudioFxService.BASS_BOOST_CHANGED;
import static org.mokee.audiofx.service.AudioFxService.EQ_CHANGED;
import static org.mokee.audiofx.service.AudioFxService.REVERB_CHANGED;
import static org.mokee.audiofx.service.AudioFxService.TREBLE_BOOST_CHANGED;
import static org.mokee.audiofx.service.AudioFxService.VIRTUALIZER_CHANGED;
import static org.mokee.audiofx.service.AudioFxService.VOLUME_BOOST_CHANGED;
...
class SessionManager implements AudioOutputChangeListener.AudioOutputChangedCallback {
    ...
    private final MoKeeAudioManager mMoKeeAudio;
    ...
    public SessionManager(Context context, Handler handler, DevicePreferenceManager devicePrefs,
        ...
        mContext = context;
        mMoKeeAudio = MoKeeAudioManager.getInstance(context);
     ...
     * feature added by MoKee which notifies when sessions are created or
